...
namespace MovieTown.Migrations
{
    ...
    [Migration("20260124132246_InitialWithMovies")]
    partial class InitialWithMovies
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MovieTown.Models.Screening", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CinemaId = 1,
                            MovieId = 1,
                            StartTime = new DateTime(2026, 1, 24, 15, 22, 45, 950, DateTimeKind.Utc).AddTicks(3337)
                        },
                        new
                        {
                            Id = 2,
                            CinemaId = 1,
                            MovieId = 2,
                            StartTime = new DateTime(2026, 1, 24, 18, 22, 45, 950, DateTimeKind.Utc).AddTicks(3489)
                        },
                        new
                        {
                            Id = 3,
                            CinemaId = 2,
                            MovieId = 3,
                            StartTime = new DateTime(2026, 1, 25, 9, 22, 45, 950, DateTimeKind.Utc).AddTicks(3491)
                        },
                        new
                        {
                            Id = 4,
                            CinemaId = 2,
                            MovieId = 4,
                            StartTime = new DateTime(2026, 1, 29, 3, 22, 45, 950, DateTimeKind.Utc).AddTicks(3492)
                        },
                        new
                        {
                            Id = 5,
                            CinemaId = 1,
                            MovieId = 5,
                            StartTime = new DateTime(2026, 1, 27, 21, 22, 45, 950, DateTimeKind.Utc).AddTicks(3494)
                        },
                        new
                        {
                            Id = 6,
                            CinemaId = 2,
                            MovieId = 6,
                            StartTime = new DateTime(2026, 1, 25, 5, 22, 45, 950, DateTimeKind.Utc).AddTicks(3494)
                        },
                        new
                        {
                            Id = 7,
                            CinemaId = 1,
                            MovieId = 7,
                            StartTime = new DateTime(2026, 1, 27, 1, 22, 45, 950, DateTimeKind.Utc).AddTicks(3495)
                        },
                        new
                        {
                            Id = 8,
                            CinemaId = 2,
                            MovieId = 8,
                            StartTime = new DateTime(2026, 1, 29, 5, 22, 45, 950, DateTimeKind.Utc).AddTicks(3496)
                        });
                });
